          ...
          child: Column(
            ...
            children: [
              ...
              _accessBullet(Icons.app_shortcut_rounded,
                  s.t('Active broker app detection: the app identifies when the user opens a trading application (MetaTrader 5 or similar) to activate risk monitoring.',
                      'Rilevamento dell\'app broker attiva: l\'app identifica quando l\'utente apre un\'applicazione di trading (MetaTrader 5 o simili) per attivare il monitoraggio del rischio.')),
